...
# ─────────────────────────────────────────────
# Lockout — field name is lockout_active (NOT is_locked)
# lockout_service.py returns lockout_active
# Dashboard reads is_locked from /api/security/status — mapped in main.py proxy
# ─────────────────────────────────────────────
